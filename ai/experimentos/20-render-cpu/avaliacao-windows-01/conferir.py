...
archive = root / 'ai/experimentos/resultado-render-cpu.zip'
...
with zipfile.ZipFile(archive) as z:
    ...
    check('rubrica prévia local', read(a+'rubric.json') == (root/'ai/experimentos/20-render-cpu/dossie/rubrica.json').read_bytes())
